...
/*   Updated: 2023/06/02 00:01:43 by tim           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/fractol.h"

static void	zoom_x(fractol_t *data, double re, int x, bool out)
{
	double	range;
	double	new_range;
	double	offset;
...
static void	zoom_y(fractol_t *data, double im, int y, bool out)
{
	double	range;
	double	new_range;
	double	offset;
